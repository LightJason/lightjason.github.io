...
* We use our own [_LightJason/AgentSpeak_](/framework/agentspeak) and [_LightJason/REST_](/framework/rest) components for modelling the agents and realising communication.
