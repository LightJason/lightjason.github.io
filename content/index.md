...
type: homepage
---
LightJason is a _lightwire multi-agent framework_ for creating a multi-agent systems with Java. The project is inspired by AgentSpeak(L) and  [Jason](http://jason.sourceforge.net), but designed and implemented from scratch.
