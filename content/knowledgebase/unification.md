...
In AgentSpeak(L++) unification can be done by using the right shift operator `>>` in combination with a literal to be unified. Terms of interest are then replaced by [variables](../variables).
